...
<div class="container">
    <div class="row justify-content-center mt-5 clearfix">
        <h2 class="text text-primary text-center">Lich Su Choi Game</h2>
    </div>
    ...
    <div class="row justify-content-center mt-5">
        <div class="col-md-8">
            <table class="table table-borderless">
                ...
                <tbody>
                <c:forEach var="item" items="${historyGames}" varStatus="loop">
                    <tr>
                        <!--id, start_time, end_time, is_completed, is_active-->
                        ...
                        <td>
                            <c:choose>
                                <c:when test="${item.endTime == null }">
                                    <a href="<%= request.getContextPath() + UrlUtils.LICH_SU%>?id=${item.id}">continue
                                        play</a>
                                </c:when>
                                <c:when test="${item.endTime != null }">
